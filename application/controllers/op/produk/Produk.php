...
class Produk extends CI_Controller
{
	...
	function index()
	{
		...
		$d['data'] = $this->mod_produk->produk_data([], "kode_produk ASC");
	...
	function add()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$photo = 'upload';
			if ($this->mod_produk->produk_add_single($toko, $kode, $nama, $kategori, $deskripsi, $stok, $harga, $berat, $photo) == TRUE) {
	...
	function edit()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$deskripsi = $this->input->post('deskripsi', TRUE);
			$photo = 'upload';
			if ($this->mod_produk->produk_edit($produkid, $kode, $nama, $kategori, $deskripsi, $harga, $berat, $photo) == TRUE) {
