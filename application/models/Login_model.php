...
class Login_model extends CI_Model
{
	...
	function user_daftar($nama = null, $username = null, $password = null, $akses = null)
	{
		$s = array(
			'username' => $username,
		);
	...
	function user_edit($userid = null, $nama = null, $username = null, $password = '', $akses = null)
	{
		$s = array(
			'user_id' => $userid,
		);
	...
	function user_delete($userid = null)
	{
		if (akses() == "admin") {
			$s = array(
				'user_id' => $userid,
	...
	function user_delete_umum($userid = null)
	{
		$s = array(
			'user_id' => $userid,
		);
