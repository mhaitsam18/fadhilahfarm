...
class Produk_model extends CI_Model
{
	...
	function merek_edit($merekID = null, $nama = null)
	{
		$s = array(
			'merek_id' => $merekID,
		);
	...
	function merek_delete($merekID = null)
	{
		$s = array(
			'merek_id' => $merekID,
		);
	...
	function warna_edit($warnaID = null, $nama = null)
	{
		$s = array(
			'warna_id' => $warnaID,
		);
	...
	function warna_delete($warnaID = null)
	{
		$s = array(
			'warna_id' => $warnaID,
		);
	...
	function ukuran_edit($ukuranID =  null, $nama = null)
	{
		$s = array(
			'ukuran_id' => $ukuranID,
		);
	...
	function ukuran_delete($ukuranID = null)
	{
		$s = array(
			'ukuran_id' => $ukuranID,
		);
	...
	function promo_add($promoID = null, $judul = null, $deskripsi = null, $nilai = null, $mulai = null, $selesai = null)
	{
		$s = array(
			'promo_id' => $promoID,
		);
	...
	function promo_edit($promoID = null, $judul = null, $deskripsi = null, $nilai = null, $mulai = null, $selesai = null)
	{
		$s = array(
			'promo_id' => $promoID,
		);
	...
	function promo_delete($promoID = null)
	{
		$s = array(
			'promo_id' => $promoID,
		);
	...
	function produk_add_single($toko = null, $kode = null, $nama = null, $kategoriID = null, $deskripsi = null, $stok = null, $harga = null, $berat = '1', $photo = '')
	{
		$d = array(
			'kode_produk' => $kode,
			'nama_produk' => $nama,
	...
	function produk_edit($produkID = null, $kode = null, $nama = null, $kategoriID = null, $deskripsi = null, $harga = null, $berat = '1', $photo = '')
	{
		$s = array(
			'produk_id' => $produkID,
		);
	...
	function produk_add_stok_single($toko = null, $produkID = null, $stok = null)
	{
		if (!empty($stok)) {
			$d = array(
				'produk_id' => $produkID,
	...
	function produk_add_stok($toko = null, $produkID = null, $stok = array())
	{
		if (!empty($stok)) {
	...
	function produk_delete($id = null)
	{
		$s = array(
			'produk_id' => $id,
		);
