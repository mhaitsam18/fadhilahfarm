...
class Transaksi_model extends CI_Model
{
	...
	function mutasi_data_detail($mutasiID = null)
	{
		$s = array(
			'mutasi_id' => $mutasiID,
		);
	...
	function mutasi_add($tokoid = null, $tanggal = null, $keterangan = null, $mutasi = array())
	{
	...
	function penjualan_add($pelangganID = null, $total = null, $kurir = null, $pelayanan = null, $ongkir = null, $produk = array(), $berat = null, $diskon = null)
	{
		$dx = array();
		if (!empty($produk)) {
	...
	function konfirmasi_pembayaran($penjualanid = null, $invoice = null, $status = 'lunas')
	{
		$s = array(
			'penjualan_id' => $penjualanid,
			'invoice' => $invoice,
