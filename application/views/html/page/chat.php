            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card m-0">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="show_chat">
                            <div class="selected-user">
                                <span>To: Operator<span class="name">
                                        <!-- Emily Russell -->
                                    </span></span>
                            </div>
                            <div class="chat-container">
                                <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
                                <div style="height: 400px; overflow: auto; width: 100%;" id="scroll" class="live1">
                                ...
                                <div class="form-group mt-3 mb-0">
                                    <form action="" method="" onsubmit="submitChat()">
                                        ...
                                        <button type="button" class="btn btn-info float-right mt-1" id="kirim-chat" onclick="kirimChat(<?= 1 ?>)">Kirim</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function kirimChat(operator_id) {
        var pesan = document.getElementById("pesan").value;
        $.ajax({
            type: 'post',
            url: '<?= base_url('Chat/kirimChat/') ?>',
            data: {
                operator_id: operator_id,
                pesan: pesan
            },
    ...
    $(document).ready(function() {
        setInterval(function() {
            $('#live<?= 1 ?>').load('<?= base_url("Chat/getChat2/1") ?>')
        }, 1000);
    });
