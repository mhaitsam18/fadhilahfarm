...
?>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			...
			$kurir = array('Ambil Sendiri', 'Armada Peternakan');
			foreach ($kurir as $rkurir) {
			?>
				<label class="radio-inline">
					<input type="radio" name="kurir" class="kurir" value="<?= ($rkurir == 'Armada Peternakan') ? 'jne' : ''; ?>" /> <?= strtoupper($rkurir); ?>
				</label>
			<?php
			}
			?>
	...
	<input type="hidden" name="hitungan" id="hitungan" value="0" />
