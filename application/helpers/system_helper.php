...
if (!function_exists('baca_konfig')) {
	function baca_konfig($nama = null)
	{
		$CI = &get_instance();
...
if (!function_exists('menu_active')) {
	function menu_active($slug2 = null)
	{
		$CI = &get_instance();
		$s = $CI->uri->segment(2);
		if ($slug2 == $s) {
...
if (!function_exists('string_create_slug')) {
	function string_create_slug($text = null)
	{
		if (empty($text)) {
			return '';
		} else {
...
if (!function_exists('string_word_limit')) {
	function string_word_limit($str = null, $limit = 20, $comaDelimiter = FALSE)
	{
		$CI = &get_instance();
		$CI->load->helper('text');
		$item = "";
...
if (!function_exists('field_value')) {
	function field_value($table = null, $key = null, $keyval = null, $output = null)
	{
		$CI = &get_instance();
		$CI->load->library('m_db');
		$s = array(
...
if (!function_exists('field_value_custom')) {
	function field_value_custom($table = null, $where = array(), $output = null)
	{
		$CI = &get_instance();
		$CI->load->library('m_db');
...
if (!function_exists('fetch_data')) {
	function fetch_data($table = null, $where = array(), $order = '', $group = '', $limit = '', $start = '')
	{
		$CI = &get_instance();
		$CI->load->library('m_db');
...
if (!function_exists('sum_data')) {
	function sum_data($table = null, $where = array(), $field = null)
	{
		$CI = &get_instance();
		$CI->load->library('m_db');
...
if (!function_exists('string_implode_array')) {
	function string_implode_array($attributes = null)
	{
		if (empty($attributes)) {
			return '';
		}
...
if (!function_exists('com_select_bulan')) {
	function com_select_bulan($name = null, $firstvalue = '', $att = array())
	{
		$arr = array(
			'1' => 'Januari',
			'2' => 'Februari',
...
if (!function_exists('date_month_name')) {
	function date_month_name($bulan = null)
	{
